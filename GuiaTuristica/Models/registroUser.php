        ...
        <div class="row">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h5 class="card-title text-center">NuestraPagina -> Guia Turistica | Registrate</h5>
                        <a class="card-title text-center text-danger bg-light" href="../Controller/login.php"><b>¿Tienes cuenta? Inicia Sesión Aquí</b></a>
                        <form action=../Controller/sesion.php method="POST" class="form-signin">
                                ...
                                <div class="form-group">
                                    <label>DPI</label>
                                    <input type="text" name="dpiUser" class="form-control" placeholder="Número de DPI"
                                        required>
                                </div>
                            <div class="form-group ">
