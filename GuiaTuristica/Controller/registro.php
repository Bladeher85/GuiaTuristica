        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active"><a href="../Models/perfilUser.php"
        ...
        <div class="row">
            <div class="col-3 bg-dark">
                <div class="nav flex-column nav-pills p-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="  nav-link" href="../Models/informe.php" role="tab" aria-controls="v-pills-settings"
                        aria-selected="false"><strong>Informe 📊</strong></a>
                    <a class=" nav-link" href="../Models/perfilUser.php" role="tab" aria-controls="v-pills-messages"
