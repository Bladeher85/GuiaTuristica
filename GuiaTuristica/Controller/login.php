        ...
        <div class="row">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h5 class="card-title text-center">NuestraPagina -> Guia Turistica | Iniciar Sesión</h5>
                        <form action=sesion.php method="POST" class="form-signin">
                            ...
                            <div class="form-label-group p-4">
                                <a class="text-danger" href="../Models/registroUser.php"><b>¿No tienes cuenta?, Registarte aquí</b></a>
                            </div>
