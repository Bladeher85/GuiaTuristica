...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Editar Hotel </h6>
  </div>
...
<?php
 $connection = mysqli_connect("localhost","root","","bd_agenciaviaje")or die ("No se ha podido conectar al servidor de Base de datos");
     ...
     if (isset($_POST['edit_btnD'])) {
         $codDestino = $_POST['idHotel'];

         $query = "SELECT * FROM hotel WHERE idHotel='$codDestino'";
         ...
         foreach ($query_run as $row) {
            ...
            <input type="hidden" name="id" value="<?php echo $row['idHotel'] ?>" >
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="edit_nomOrigen" value="<?php echo $row['nombreHotel'] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label> Direccion</label>
                        <input type="text" name="edit_direccion" value="<?php echo $row['direccion'] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label> Departamento</label>
                        <input type="text" name="edit_depa" value="<?php echo $row['departamento'] ?>" class="form-control">
                    </div>
                    
                    
                        <a href="hotel.php" class="btn btn-danger">Cancelar</a>
