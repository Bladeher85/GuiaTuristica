<?php 
    include_once '../../Models/verificar.php';
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../index.php">
                ...
                <div class="sidebar-brand-text mx-3">Guia Turistica </div>
            </a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Agregue lugar de origen</h5>
                                ...
                                <form action="../../Models/codigo.php" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombre_Origen" class="form-control"
                                                placeholder="Ingrese el nombre del lugar de origen">
                                        </div>
                                        <div class="form-group">
                                            <label> Código del lugar de origen </label>
                                            <input type="number" name="codigo_Origen" class="form-control"
                                                placeholder="Ingrese el código del lugar de origen">
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-dismiss="modal">Cerrar</button>
                                        <button type="submit" name="btn_origen"
                                            class="btn btn-primary">Guardar Origen</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-0 text-gray-800">Lugares de Origen</h1>
                                    <button type="button"
                                        class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"
                                        data-toggle="modal" data-target="#addadminprofile">
                                        <i class="fas fa-user-plus"></i> Añadir lugar de origen</button>
                                </div>
                            </div>
    ...
    ?>
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Código de Lugar Origen </th>
                                                <th>Nombre de Lugar Origen </th>
                                                <th>EDITAR </th>
                                                <th>ELIMINAR </th>
                                            </tr>
                                        </thead>
        ...
        ?>
                                            <tr>
                                                ...
                                                <td> <?php echo $row['nombreOrigen']; ?> </td>
                                                <td>
                                                    <form action="editOrigen.php" method="post">
                                                        <input type="hidden" name="codigoOrigen"
                                                            value="<?php echo $row['codigoOrigen']; ?>">
                                                        <button type="submit" name="edit_btn" class="btn btn-warning"><i
                                                                class="fas fa-edit"></i> EDITAR</button>
                                                    </form>
                                                </td>
                                                <td>
                                                    <form action="../codigo.php" method="post">
                                                        <input type="hidden" name="delete_idO"
                                                            value="<?php echo $row['codigoOrigen']; ?>">
                                                        <button type="submit" name="delete_btnO"
