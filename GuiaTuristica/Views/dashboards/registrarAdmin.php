                            ...
                            <div class="modal-content">
                                ...
                                <form action="../../Models/codigo.php" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" name="rol_Usuario" value="1">
                                        <input type="hidden" name="codV_admin" class="text-danger btn btn-lg bg-white font-weight-bold"  value="<?php echo rand(100,10000); ?> ">
                            ...
                            <div class="card-header py-3">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <button type="button"
                                        ...
                                        <i class="fas fa-user-plus"></i> Añadir usuarios administradores</button>
                                </div>
                            </div>
