...
<?php
 $connection = mysqli_connect("localhost","root","","bd_agenciaviaje")or die ("No se ha podido conectar al servidor de Base de datos");
     ...
     if (isset($_POST['edit_btn'])) {
         ...
         $query = "SELECT * FROM usuario WHERE rol_id = 1 AND dpiUser='$id'";
         ...
         foreach ($query_run as $row) {
            ...
            <form action="../../Models/codigo.php" method="POST">
            <input type="hidden" name="edits_id" value="<?php echo $row['dpiUser'] ?>" >
                    ...
                    <div class="form-group">
                        <label> Cédula</label>
                        <input type="text" name="edit_cedula" value="<?php echo $row['dpiUser'] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Contraseña</label>
                        <input type="text" name="edit_password" value="<?php echo $row['passwor'] ?>"  class="form-control">
                    </div>   
                    <div class="form-group">
                        ...
                        <a href="registrarAdmin.php" class="btn btn-danger">Cancelar</a>
