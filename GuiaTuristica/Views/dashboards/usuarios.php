                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Tabla de Usuarios Registrados</h1>
                                </div>
                            </div>
                                ...
                                echo "<table class=table-bordered id=dataTable width=100%>";
                                    echo"<thead class=bg-dark>";
                                        echo "<tr class=text-white>";
                                            ...
                                            echo "<td class=p-1 align=center> DPI</td>";
                                            echo "<td align=center> Nombre Usuario </td>";
                                            echo "<td class=p-1 align=center> Nombre </td>";
                                            echo "<td class=p-1 align=center> Codigo de Viaje</td>";
                                            echo "<td class=p-1 align=center> telefono</td>";
                                            echo "<td class=p-1 align=center> Contraseña</td>";
                                        echo "</tr>";
                                    echo"</thead>";
