...
<head>
    ...
    <title>NuestraPagina -> Guia Turistica ✈ - Dashboard</title>
                                ...
                                <form action="../../Models/codigo.php" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="dpiAdmin" class="form-control"
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Editar Origen </h6>
  </div>
...
<?php
 $connection = mysqli_connect("localhost","root","","bd_agenciaviaje")or die ("No se ha podido conectar al servidor de Base de datos");
     ...
     if (isset($_POST['edit_btn'])) {
         $codOrigen = $_POST['codigoOrigen'];

         $query = "SELECT * FROM origen WHERE codigoOrigen='$codOrigen'";
         ...
         foreach ($query_run as $row) {
            ...
            <form action="../../Models/codigo.php" method="POST">
            <input type="hidden" name="id" value="<?php echo $row['codigoOrigen'] ?>" >
                
                     <div class="form-group">
                        <label> Nombre del lugar de origen </label>
                        <input type="text" name="edit_nomOrigen" value="<?php echo $row['nombreOrigen'] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label> Código del lugar de origen</label>
                        <input type="number" name="codOrigen" value="<?php echo $row['codigoOrigen'] ?>" class="form-control">
                    </div>
                    
                        <a href="origen.php" class="btn btn-danger">Cancelar</a>
                        <button type="submit" name="updatebtnOrigen" class="btn btn-success"> Actualizar </button>
            </form>
        <?php
        }
    }
...
<!-- /.container-fluid -->
          ...
          All rights reserved NuestraPagina | Analisis de Sistemas 1<i class="icon-heart"
                            aria-hidden="true"></i> by <a href="" target="_blank">Proyecto Final</a>
          </div>
                </div>
            </footer>
            <!-- End of Footer -->
